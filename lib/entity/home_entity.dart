...
class Hotel {
  ...
  Hotel.fromJson(Map<String, dynamic> json) {
    ...
    mainItem = json['mainItem'] != null
        ...
        : null;
    item1 =
        json['item1'] != null ? new LocalNavList.fromJson(json['item1']) : null;
    item2 =
        json['item2'] != null ? new LocalNavList.fromJson(json['item2']) : null;
    item3 =
        json['item3'] != null ? new LocalNavList.fromJson(json['item3']) : null;
    item4 =
        json['item4'] != null ? new LocalNavList.fromJson(json['item4']) : null;
  }
...
class Item3 {
  ...
  Item3({this.title, this.url, this.hideAppBar, this.statusBarColor});
